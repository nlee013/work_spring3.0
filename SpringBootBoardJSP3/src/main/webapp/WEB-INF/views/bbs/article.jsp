...
<div id="bbs">
	...
	<div id="bbsArticle_footer">
		<div id="leftFooter">
			...
			onclick="javascript:location.href='<%=cp%>/updated.action?commuNo=${dto.commuNo }&${params }';"/>
			<input type="button" value=" 삭제 " class="btn2"
			onclick="javascript:location.href='<%=cp%>/deleted_ok.action?commuNo=${dto.commuNo }&${params }';"/>
		</div>
		<div id="rightFooter">
