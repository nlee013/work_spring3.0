					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="<%=cp%>/qa_list.action">Contact<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
...
<div id="bbsList">
	...
	<div id="bbsList_header">
		...
		<form action="" method="post" name="searchForm">
			<select name="searchKey" class="selectField">
				<option value="cmSubject">제목</option>
				<option value="userId">아이디</option>
				<option value="cmContent">내용</option>
			</select>
	...
	<div id="bbsList_list">
		<div id="title">
			<dl>
				<dt class="commuNo">번호</dt>
				<dt class="cmSubject">제목</dt>
		...
		<c:forEach var="dto" items="${lists }">
			<dl>
				<dd class="commuNo">${dto.commuNo }</dd>
				<dd class="cmSubject">
				<a href="${articleUrl }&commuNo=${dto.commuNo}">
					${dto.cmSubject }
				</a>
				</dd>
